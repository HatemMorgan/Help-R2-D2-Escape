...
/**
 * Breadth​ ​First​ ​Search ​the​ ​queuing​ ​data​ structure​ ​is​ ​a​ q ueue,​ ​ which​ ​is​ ​a FIFO(First​ ​In​ ​First​ ​Out)​ ​ data​ ​structure.
 */
	...
	public TreeNode remove() {
		...
		do {
			try {
				...
				// if queue is empty then return null indicating that queue is
				// empty
